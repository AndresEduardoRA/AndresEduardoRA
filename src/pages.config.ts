...
export const pagesConfig = {
  ...
  projects: {
    ...
    description:
      "Detailed case studies showcasing problem-solving approach, technical decisions, and measurable impact across various engineering projects.",
    heading: "Projects",
    intro:
      "Case studies that demonstrate how I approach complex problems, make technical decisions, and deliver measurable impact. Each project tells the story of the challenge, the constraints, the decisions made, and the outcomes achieved.",
  },
   ...
   */
  speaking: {
    title: "Programming Explainers",
    description:
      "Video explainers covering key programming concepts, development fundamentals, and practical coding techniques.",
    heading: "Programming Explainers",
    intro:
      "I create short videos explaining important programming concepts and development techniques. Each video focuses on making complex ideas easier to understand through clear explanations and practical examples.",
  },
